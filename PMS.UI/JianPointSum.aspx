<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JianPointSum.aspx.cs" Inherits="PMS.UI.JianPointList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#dg').datagrid({
                ...
                queryParams: {
                    Method: "GetPageSubintPointByCondition"
                },
                pagination: true,
                striped: true,
                singleSelect: true,
                columns: [[
                    ...
                    { field: 'CO_Remark', title: '备注', width: 100, align: 'center' }
