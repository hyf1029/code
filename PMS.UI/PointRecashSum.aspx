<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PointRecashSum.aspx.cs" Inherits="PMS.UI.PointRecashSum" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#dg').datagrid({
                ...
                queryParams: {
                    Method: "GetPagePointReCashSumByCondition"
                },
                pagination: true,
                striped: true,
                singleSelect: true,
                columns: [[
                    ...
                    { field: 'MC_Name', title: '会员姓名', width: 100, align: 'center' },
                     { field: 'CO_GavePoint', title: '减去积分', width: 200, align: 'center' },
